    ...
    <div className="mt-[24px] w-full lg:h-[574px] bg-hero2 flex justify-center items-center min-h-[600px]">
      <div className="w-full flex flex-col justify-center items-center gap-[24px] mb-[80px] lg:mb-[64px] mt-[48px] lg:mt-0">
        ...
        <ButtonLink
          ...
          to="/schedule"
          type="button"
          className="w-auto w-[300px] h-[62px] rounded-full transition ease-in-out px-[24px] pt-4 pb-4 bg-white text-primary-blue hover:bg-light-grey transition ease-in-out duration-300 active:scale-90 flex justify-center items-center"
        >
