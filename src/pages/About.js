...
function About() {
  ...
  return (
    <div className="flex flex-col justify-center items-center">
      {/* Header Sec New */}
      <div className="w-full h-screen flex flex-col justify-center items-center gap-[64px] pt-[64px] pb-[96px] lg:pt-[96px] lg:pb-[200px] mt-[64px] lg:mt-[64px] px-[24px] md:px-[56px] bg-light-grey-blue relative overflow-hidden">
