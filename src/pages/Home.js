        ...
        <div className="w-full flex flex-col justify-center items-center gap-[24px]">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-[32px] px-[0px]">
            <ButtonLink
              ...
              to="/schedule"
              type="button"
              className="w-auto w-[294px] h-[62px] rounded-full transition ease-in-out px-[24px] pt-4 pb-4 bg-dark text-white hover:bg-primary-blue-hover transition ease-in-out duration-300 active:scale-90 flex justify-center items-center"
            >
              <h4 className=" text-[20px] font-bold text-center">
